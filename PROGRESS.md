...
- **Active task:** none. P2-01a/P2-02a are verified; next product task is MVP-TRIAL on a user-selected development folder. CI routing preference remains pending.
