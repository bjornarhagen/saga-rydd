...
func capabilities() map[string]any {
	...
	return map[string]any{
		...
		"features":    map[string]bool{"experimental_inventory": true, "durable_dispatch_limits": true, "wal_backpressure": true, "metadata_rate_limit": false, "cpu_limit": false, "power_controls": false, "findings": false, "duplicates": false, "cleanup": false, "service_installation": false},
	}
}
